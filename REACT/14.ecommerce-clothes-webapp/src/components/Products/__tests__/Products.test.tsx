...
describe("Products", () => {
  ...
  it("should show filtered products list", async () => {
    ...
    const fetchedProductsCount = screen.getByLabelText("products list").children
      .length;
    ...
    const filteredProductsCount = screen.getByLabelText("products list")
      .children.length;
    ...
    const updatedProductsCount = screen.getByLabelText("products list").children
      .length;
